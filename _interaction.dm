...
/datum/interaction/proc/post_interaction(mob/living/carbon/human/A, mob/target)
	if(interaction_sound)
		if(interaction_sound_age_pitch)
			playsound(A.loc, interaction_sound, 50, 1, -1)//, pitch = user.get_age_pitch())
		else
			playsound(A.loc, interaction_sound, 50, 1, -1)
	return
/*
